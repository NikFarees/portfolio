    ...
    <div className="max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="mb-16">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-[#111111] border border-[#262626] rounded-lg p-5">
            <p className="font-mono text-accent text-xs mb-1">Sep 2022 — Feb 2026</p>
            <h4 className="text-[#e5e5e5] font-semibold mb-1">
              Bachelor of IT (Hons) in Software Engineering
            </h4>
            <p className="text-[#a3a3a3] text-sm">University Kuala Lumpur (MIIT)</p>
            <p className="text-[#a3a3a3] text-sm mt-1">
              CGPA: <span className="text-accent font-mono">3.81</span>
            </p>
          </div>
          <div className="bg-[#111111] border border-[#262626] rounded-lg p-5">
            <p className="font-mono text-accent text-xs mb-1">Aug 2021 — Aug 2022</p>
            <h4 className="text-[#e5e5e5] font-semibold mb-1">
              Foundation in Computer Technology
            </h4>
            <p className="text-[#a3a3a3] text-sm">University Kuala Lumpur (MIIT)</p>
            <p className="text-[#a3a3a3] text-sm mt-1">
              CGPA: <span className="text-accent font-mono">3.93</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {skillGroups.map(({ category, skills }) => (
            <div key={category} className="bg-[#111111] border border-[#262626] rounded-lg p-5">
              <p className="font-mono text-accent text-xs mb-3">{category}</p>
              <div className="flex flex-wrap gap-2">
                {skills.map((skill) => (
                  <span
                    key={skill}
                    className="text-xs bg-[#1a1a1a] border border-[#262626] text-[#e5e5e5] px-2 py-1 rounded font-mono"
                  >
                    {skill}
                  </span>
                ))}
      ...
      <div>
        ...
        <div className="flex gap-4 flex-wrap">
          <span className="bg-[#111111] border border-[#262626] text-[#a3a3a3] text-sm px-4 py-2 rounded">
